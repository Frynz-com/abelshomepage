      ...
      <main className="bg-cream min-h-screen">
                ...
                {openPositions.map((pos) => (
                  <div key={pos.title} className="bg-cream p-8 lg:p-10 group">
                    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                      ...
                      <a
                        href={`mailto:karriere@abels-immobilien.de?subject=${encodeURIComponent("Bewerbung: " + pos.title)}`}
        ...
        <section className="max-w-[1440px] mx-auto px-6 lg:px-20 py-20 lg:py-24 border-t border-line/40">
          <div className="max-w-[680px]">
            ...
            <a
              href="mailto:karriere@abels-immobilien.de?subject=Initiativbewerbung"
