...
export function EssenHeroSection() {
          ...
          <div className="max-w-[1440px] mx-auto px-6 lg:px-20 w-full">
            <div className="grid lg:grid-cols-12 items-end gap-12">
              <div className="lg:col-span-7 xl:col-span-6">
                ...
                >
                  Haus & Villa<br />
                  <span className="text-white/82">verkaufen in Essen.</span>
                </motion.h1>
                ...
                >
                  Abels Immobilien begleitet anspruchsvolle Eigentümer beim Verkauf von Wohnungen, Häusern und Villen in Bredeney, Kettwig und den exklusiven Lagen am Baldeneysee.
                </motion.p>
              ...
              >
                <div className="flex flex-col gap-8 items-end text-right">
                  {[
                    { value: "Bredeney", label: "Exklusive Villenlage" },
                    { value: "Baldeneysee", label: "Wohnen am See" },
                    { value: "Kettwig", label: "Historisches Flair" },
                  ].map((item, i) => (
