              ...
              <div className="lg:col-span-7 xl:col-span-6">
                ...
                >
                  ...
                  <span className="text-gold text-[11px] uppercase tracking-[0.28em]">
                    Premium-Makler · 7 Standorte · Seit 1999
                  </span>
                </motion.div>
                ...
                >
                  Ihre Immobilie.<br />
                  <span className="text-white/82">Diskret verkauft.</span>
                </motion.h1>
                ...
                >
                  Abels Immobilien begleitet anspruchsvolle Eigentümer beim Verkauf hochwertiger Wohnimmobilien in Düsseldorf, München, Hamburg, Frankfurt und drei weiteren Städten.
                </motion.p>
              ...
              >
                <div className="flex flex-col gap-8 items-end text-right">
                  {[
                    ...
                    { value: "7 Standorte", label: "Deutschlandweit" },
