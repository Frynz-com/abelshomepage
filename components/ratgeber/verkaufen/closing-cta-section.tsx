      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-20">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <h2 className="font-serif text-4xl lg:text-5xl text-cream leading-[1.1] mb-8">
            ...
            <div className="border border-white/10 p-10 lg:p-12">
              ...
              <div className="space-y-6">
                <a href="tel:+492115591751" className="flex items-center gap-4 group">
                  <div className="w-12 h-12 border border-white/20 flex items-center justify-center group-hover:border-gold transition-colors">
                    <Phone className="w-5 h-5 text-gold" />
                  </div>
                  <div>
                    <span className="block text-xs text-cream/50 uppercase tracking-[0.1em] mb-1">Telefon</span>
                    <span className="block text-cream font-medium group-hover:text-gold transition-colors">+49 211 5591751</span>
                  </div>
                </a>
                ...
                <a href="mailto:info@abels-immobilien.de" className="flex items-center gap-4 group">
                  ...
                  <div>
                    ...
                    <span className="block text-cream font-medium group-hover:text-gold transition-colors">info@abels-immobilien.de</span>
                  </div>
                </a>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <span className="block text-xs text-cream/50 uppercase tracking-[0.1em] mb-1">Hauptsitz</span>
                    <span className="block text-cream/80">Alt Niederkassel 124, 40547 Düsseldorf</span>
                  </div>
                </div>
              </div>
