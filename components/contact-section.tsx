          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="tel:+4912345678900" className="text-foreground hover:text-foreground/70 transition-colors">
                  +49 123 456 789 00
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="mailto:info@abels-immobilien.de" className="text-foreground hover:text-foreground/70 transition-colors">
