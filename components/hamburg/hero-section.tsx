...
export function HamburgHeroSection() {
    ...
    <section className="relative h-screen min-h-[700px] flex flex-col overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          alt="Immobilienmakler Hamburg – Abels Immobilien"
          fill
          priority
          ...
          <div className="max-w-[1440px] mx-auto px-6 lg:px-20 w-full">
            <div className="grid lg:grid-cols-12 items-end gap-12">
              <div className="lg:col-span-7 xl:col-span-6">
                ...
                >
                  Ihre Immobilie<br />
                  <span className="text-white/82">in Hamburg verkaufen.</span>
                </motion.h1>
                ...
                >
                  Abels Immobilien begleitet anspruchsvolle Eigentümer beim Verkauf von Wohnungen, Häusern und Villen in Harvestehude, Blankenese und den besten Lagen Hamburgs.
                </motion.p>
              ...
              >
                <div className="flex flex-col gap-8 items-end text-right">
                  {[
                    { value: "Harvestehude", label: "Beste Lage" },
                    { value: "Blankenese", label: "Elbhang & Villen" },
                    { value: "HafenCity", label: "Modernes Wohnen" },
                  ].map((item, i) => (
