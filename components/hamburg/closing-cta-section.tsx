...
export function HamburgClosingCtaSection() {
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-20 py-24 lg:py-32">
          ...
          >
            ...
            <h2 className="font-serif text-[clamp(2.8rem,6vw,5.5rem)] text-cream leading-[0.97] tracking-[-0.02em] max-w-[900px]">
              Immobilie in Hamburg<br />
              <span className="text-cream/55">professionell verkaufen.</span>
            </h2>
          </motion.div>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-12">
          ...
          >
            <p className="text-[16px] text-cream/60 leading-[1.7] mb-10 max-w-[460px]">
              Ob Harvestehude-Wohnung, Blankenese-Villa oder diskreter Verkauf am Elbhang — wir begleiten Sie mit Hamburger Marktkenntnis und persönlichem Engagement durch jeden Schritt.
            </p>
          ...
          >
            <h3 className="text-[11px] uppercase tracking-[0.22em] text-cream/40 mb-8">Direkter Kontakt</h3>
            <div className="space-y-5">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <span className="block text-[15px] text-cream/75">Alt Niederkassel 124, 40547 Düsseldorf</span>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 border border-cream/12 flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <span className="block text-[15px] text-cream/75">Mo–Fr 9:00–18:00 Uhr</span>
                  <span className="block text-[13px] text-cream/40">Sa nach Vereinbarung</span>
                </div>
              </div>
            </div>
          </motion.div>
