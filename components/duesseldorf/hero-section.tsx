...
export function DuesseldorfHeroSection() {
  ...
  return (
    <section className="relative h-screen min-h-[700px] flex flex-col overflow-hidden">
      <div className="absolute inset-0 z-0">
        ...
        <Image
          src="/images/cities/duesseldorf.jpg"
          alt="Immobilienmakler Düsseldorf – Abels Immobilien"
          fill
          priority
            ...
            <div className="grid lg:grid-cols-12 items-end gap-12">
              ...
              >
                <div className="flex flex-col gap-8 items-end text-right">
                  {[
                    { value: "Oberkassel", label: "Rheinlage" },
                    { value: "Kaiserswerth", label: "Historische Villenlagen" },
                    { value: "Golzheim", label: "Gehobenes Wohnen" },
                  ].map((item, i) => (
