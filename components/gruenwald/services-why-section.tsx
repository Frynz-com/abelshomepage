...
const services = [
  ...
  { title: "Interessentenprüfung", text: "Nicht jede Anfrage ist automatisch relevant. Wir achten auf eine qualifizierte Vorauswahl und strukturierte Kommunikation mit passenden Interessenten." },
