...
export function FrankfurtHeroSection() {
          ...
          <div className="max-w-[1440px] mx-auto px-6 lg:px-20 w-full">
            <div className="grid lg:grid-cols-12 items-end gap-12">
              <div className="lg:col-span-7 xl:col-span-6">
                ...
                >
                  Ihre Immobilie<br />
                  <span className="text-white/82">in Frankfurt verkaufen.</span>
                </motion.h1>
                ...
                >
                  Abels Immobilien begleitet anspruchsvolle Eigentümer beim Verkauf hochwertiger Wohnimmobilien im Westend, Sachsenhausen und den Premiumlagen Frankfurts.
                </motion.p>
              ...
              >
                <div className="flex flex-col gap-8 items-end text-right">
                  {[
                    { value: "Westend", label: "Beste Citylage" },
                    { value: "Sachsenhausen", label: "Urbanes Wohnen" },
                    { value: "Diplomatenviertel", label: "Internationale Käufer" },
                  ].map((item, i) => (
